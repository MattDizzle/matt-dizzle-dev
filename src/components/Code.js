...
export default function Code() {
    return (
        <div>
            ...
            <Card source='https://github.com/MattDizzle/weatherwatch-client/blob/main/Screenshots/Home.JPG?raw=true' rev = 'reverse' title='Weather Watch' paragraph='Created using Node.js and React'/>
        </div>
    )
}
