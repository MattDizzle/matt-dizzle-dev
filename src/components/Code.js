...
export default function Code() {
    return (
        <div className='code-page'>
            <CodeCard card='code-card' codeLink='https://github.com/MattDizzle/Saneful2020-api' liveLink='https://saneful.vercel.app/' source='https://raw.githubusercontent.com/MattDizzle/favicon-host/master/saneful/gameview.JPG' title='Saneful' paragraph='I used PostgreSQL, React, Express, Node.js, HTML5, CSS and Javascript to create this app.'/>
